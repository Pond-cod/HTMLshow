                ...
                <div className="flex items-center gap-2 sm:gap-3 shrink-0">
                  {selectedProject.html_drive_id && (
                    <a 
                      ...
                      className="hidden sm:flex items-center gap-2 px-3 py-1.5 bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-yellow-400 rounded-xl font-medium transition-colors text-xs border border-slate-700"
                    >
