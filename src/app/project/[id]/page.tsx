  ...
  return (
    <div className="min-h-screen bg-gray-900 flex flex-col">
      ...
      {(project.manual_url || project.learning_url) && (
        <div className="flex flex-wrap items-center gap-4 p-4 mt-[73px] border-b border-white/5 bg-gray-900/80 backdrop-blur-md">
          {project.manual_url && (
            <a
      ...
      */}
      <main className={`flex-1 w-full ${(project.manual_url || project.learning_url) ? '' : 'mt-[73px]'}`}>
        {project.html_drive_id ? (
          <iframe
            ...
            title={project.title}
            className={`w-full border-0 bg-white ${(project.manual_url || project.learning_url) ? 'h-[calc(100vh-146px)]' : 'h-[calc(100vh-73px)]'}`}
